  ...
  return (
      <div className='sm:absolute mx-auto sm:left-[16rem] sm:w-[50%] w-[98%]'>
          <section>
            ...
            <article className=' lg:flex bg-white rounded-2xl hover:shadow-2xl shadow-sm cursor-pointer transition-all duration-300 ease-in-out font-serif mb-4'>
            ...
            <section className='justify-evenly w-full lg:flex hidden'>
                <article className='max-w-sm w-[23rem] m-1 lg:max-w-full lg:flex bg-white rounded-2xl hover:shadow-2xl shadow-sm cursor-pointer transition-all duration-300 ease-in-out font-serif mb-4'>
                    <div className='flex'>
